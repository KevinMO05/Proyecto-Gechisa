...
Partial Class frmRegistrarVendedor
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmRegistrarVendedor))
        ...
        DataVendedores = New DataGridView()
        ...
        CType(DataVendedores, ComponentModel.ISupportInitialize).BeginInit()
        ...
        PanelContenido.Controls.Add(DataVendedores)
        ...
        ' DataVendedores
        ' 
        DataVendedores.AllowUserToAddRows = False
        DataVendedores.AllowUserToDeleteRows = False
        DataVendedores.AllowUserToResizeColumns = False
        DataVendedores.BackgroundColor = Color.White
        DataVendedores.BorderStyle = BorderStyle.None
        DataVendedores.CellBorderStyle = DataGridViewCellBorderStyle.None
        DataVendedores.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
        DataVendedores.EnableHeadersVisualStyles = False
        DataVendedores.Location = New Point(12, 18)
        DataVendedores.Name = "DataVendedores"
        DataVendedores.RowHeadersVisible = False
        DataVendedores.SelectionMode = DataGridViewSelectionMode.FullRowSelect
        DataVendedores.Size = New Size(551, 324)
        DataVendedores.TabIndex = 1
        ' 
        ' PanelLateral
        ' 
        ...
        PanelDatos.Controls.Add(cbo_Ciudad)
        ...
        Label9.Name = "Label9"
        Label9.Size = New Size(226, 24)
        Label9.TabIndex = 17
        Label9.Text = "Registrar Vendedor"
        ' 
        ' cbo_Ciudad
        ' 
        cbo_Ciudad.FormattingEnabled = True
        cbo_Ciudad.Location = New Point(438, 159)
        cbo_Ciudad.Name = "cbo_Ciudad"
        cbo_Ciudad.Size = New Size(223, 23)
        cbo_Ciudad.TabIndex = 16
        ' 
        ' txtContraseña
        ' 
        ...
        CType(DataVendedores, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents DataVendedores As DataGridView
